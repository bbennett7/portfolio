    ...
    render() {
        return(
            <div className="Home">
                ...
                <HomeIcon greyFile={VHGrey} colorFile={VHColor} title="Velvet Hammer Music and Management" firstLine="Junior Manager for Grammy-award winning and nominated artists"/>
                ...
                <HomeIcon greyFile={HGrey} colorFile={HColor} title="Wellness and Active Lifestyle Enthusiast" firstLine="Yogi" secondLine="Runner" thirdLine="Rock climber" fourthLine="Meitation novice"/>
            </div>
        )
    }
}