    ...
    render() {
        return(
            <div className="Code-Coach">
                ...
                <p>When a student signs up, she can view and select an unpaired software engineer to be her coach based on the engineer's experience, programming languages, GitHub, and location. Once the selection is made, the coach can upload links to open source materials based on a student's interests and experience level, creating a custom curriculum tailored to the student's needs.</p>
