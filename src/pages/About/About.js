      ...
      <div className={styles.container}>
        ...
        <div className={styles.wrapper}>
          <p>
            ...
            industry. Her career started at Velvet Hammer Music and Management Group, where she
            worked with artists such as System Of A Down, The Smashing Pumpkins, Code Orange, AFI,
            Deftones, Alice In Chains, and others on all aspects of their careers, from record
            rollouts, to publishing and rights management, to international tours.
          </p>
          <p>
          ...
          <p>
            ...
            Bryn&apos;s other passions include literature, vintage records, traveling, and
            gardening.
          </p>
        </div>
      </div>
